...
data <- simdat.cov(n=1000000,               #total number of observations
                   ...
                   bstar=3.109,            # increase in median survival for being treated with B
...
plot(kmfit, lty=c("solid","dashed"), col=c("blue","green"),xlim=c(0,90),
...
test <- readRDS("Results/sim2/PH.ss150trteff3covs.fem.age.neg2.fem3.LTFU0.02t")
